...
class UR5_robotiq():
    ...
    def AdmittanceCtrl(self, action):
        ...
        targetPos[2] = currentPose[2] - 0.0005*(action[2]+1)#.item()+0.8)
        ...
        Md[1] = 1.0#1.0#
        Md[2] = 1.0#1.0
        Md[3] = 0.001* Deg2Rad#0.001 * Deg2Rad
        Md[4] = 0.001* Deg2Rad#0.001 * Deg2Rad
        Md[5] = 0.0001* Deg2Rad#0.0001 * Deg2Rad
        ...
        Kd[1] = 25.0 #250.0
        Kd[2] = 100.0 #1000.0
        Kd[3] = 0.0025 * Deg2Rad#0.025 * Deg2Rad
        Kd[4] = 0.0025 * Deg2Rad#0.025 * Deg2Rad
        Kd[5] = 0.00025 * Deg2Rad#0.0025 * Deg2Rad
